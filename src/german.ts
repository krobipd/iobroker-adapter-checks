...
export const GERMAN_PHRASES: readonly string[] = [
  ...
  "wird jetzt",
  "werden jetzt",
  // Single words from the repository checker's own list (lib/M6000_Readme.js GERMAN_WORDS, 0.15.0): none of them is an
  // English word. Left out on purpose: "die" (an English verb) and "mit" (the MIT licence).
  "das",
  "der",
  "ist",
  "nicht",
